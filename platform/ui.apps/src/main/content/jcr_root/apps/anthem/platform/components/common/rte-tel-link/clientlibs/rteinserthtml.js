...
(function (CUI) {
  ...
  CUI.rte.commands.RTEInsertHtml = new Class({

    toString: 'rteinserthtml',

    extend: CUI.rte.commands.Command,

    isCommand: function (cmdStr) {
      return (cmdStr.toLowerCase() === 'rteinserthtml');
    },
...
// register command
  CUI.rte.commands.CommandRegistry.register('rteinserthtml',
    CUI.rte.commands.RTEInsertHtml);
