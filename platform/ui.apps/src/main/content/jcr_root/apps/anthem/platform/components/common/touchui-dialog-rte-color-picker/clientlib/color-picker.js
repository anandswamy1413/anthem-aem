$.getScript('https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/4.0.11/handlebars.js', function() {
    ...
    var GROUP = "experience-aem",
        ...
        REQUESTER = "requester",
        PICKER_URL = "/apps/anthem/platform/components/common/touchui-dialog-rte-color-picker/color-picker-popover/cq:dialog.html";
    ...
    function addDialogTemplate(){
        ...
        var html = "<iframe width='550px' height='250px' frameBorder='0' src='" + url + "'></iframe>";
...
(function($, $document){
   ...
   function queryParameters() {
    ...
    function stylePopoverIframe(){
        ...
        $colorPicker.css("margin-bottom", "15px");

        $(ADD_COLOR_BUT).css("margin-left", "120px");
